                ...
                <div class="col-md-6">
                    <section class="payment-card">
                        ...
                        <div class="cost">
                            <div class="row justify-content-between">
                                ...
                                <div class="col-md-2">
                                    <ul class="mb-0">
                                        <li>INR</li>
                                        <li><img src="{{ asset('storage/inr_logo.webp') }}" style="max-width:35px;"
                                                class="img-fluid"></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <ul class="hrs">
                            ...
                            <li>₹{{ number_format(session('priceWithoutTax') ?? $hotel->price_per_day, 2) }}</li>
                        </ul>
                        <ul class="discnt">
                        ...
                        <p class="paradetail">By continuing, you agree to Hotel’ <b><a
                                    style="text-decoration:none;color:black;" target="_blank"
                                    href="https://justboardrooms.com/terms-of-use/">Terms of Use</a></b> and
                            <b><a style="text-decoration:none;color:black;" target="_blank"
                                    href="https://justboardrooms.com/privacy-policy/">Privacy Policy</a></b>.<br><br> For
                            details about cancellations, please read our <b><a style="text-decoration:none;color:black;"
                                    target="_blank" href="https://api.justboardrooms.com/api-PROD/terms.php">Cancellation
                                    Policy</a></b> within our <b><a style="text-decoration:none;color:black;"
                                    target="_blank" href="https://api.justboardrooms.com/api-PROD/terms.php">Member
                                    Agreement</a></b>.
                        </p>
                        <a href="{{ route('confirmBooking') }}"><button type="button" class="btn btn-primary"
                                data-bs-toggle="modal" data-bs-target="#paymentModal">Confirm Booking</button> </a>
                    </section>
                </div>
            </div>
        </div>
