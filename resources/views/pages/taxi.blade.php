            ...
            <div class="col-lg-12 text-justify">
                ...
                <table border="0" cellspacing="1" cellpadding="1" width="100%">
                    <tbody>
                        <tr>
                            <td bgcolor="#ffffff">
                                <div align="center"><img src="https://www.gayatobodhgaya.com/images/indica-2.jpg"
                                        alt="Car Rental Bodhgaya" title="Car rental bodhgaya" width="80" height="50"
                                        border="0"></div>
                            </td>
                            <td bgcolor="#ffffff" valign="bottom">
                                <div align="center"><img src="https://www.gayatobodhgaya.com/images/innova.jpg"
                                        alt="Gaya car rental agent" title="Gaya car rental agent " width="80"
                                        height="50" border="0"></div>
                            </td>
                            <td bgcolor="#ffffff">
                                <div align="center">
                                    <img src="https://www.gayatobodhgaya.com/images/tempo.jpg"
                                        alt=" Bodh gaya airport car rental" title="bodh gaya airport car rental"
                                        width="80" height="50" border="0">
                                </div>
                            </td>
                            <td bgcolor="#ffffff">
                                <div align="center">
                                    <img src="https://www.gayatobodhgaya.com/images/coach.jpg"
                                        alt=" car rental at bodhgaya airport" title=" car rental at bodhgaya airport"
                                        width="80" height="50" border="0">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="style5" bgcolor="#ffffff">
                                <div align="center"><strong>Indigo </strong></div>
                            </td>
                            <td class="style5" bgcolor="#ffffff">
                                <div align="center"><strong>Innova </strong></div>
                            </td>
                            <td class="style5" bgcolor="#ffffff">
                                <div align="center"><strong>Tempo Traveller</strong></div>
                            </td>
                            <td class="style5" bgcolor="#ffffff">
                                <div align="center"><strong>Deluxe Coach </strong></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
                <br>
                <span
                    style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#000000; font-weight:bold; text-align:left; ">
                    <table width="100%" border="1" cellspacing="0" cellpadding="4"
                        style="padding:8px; border-collapse:collapse" class="table">
                        <tbody>
                            <tr>
                                <td scope="col" width="34%">Particulars</td>
                                <td width="18%">
                                    Etios/Swift
                                    A/c Car
                                </td>
                                <td scope="col" width="15%">
                                    <a href="bodhgaya-car-rental.html" title="Bodh Gaya Car Rental " target="_new">Toyota
                                        Innova</a>
                                    car
                                </td>
                                <td scope="col" width="19%">
                                    <a href="tempo-traveller-mini-van.html" title="Hire Luxury Bus Coach"
                                        target="_new">Aircon Tempo</a>
                                    Traveller
                                </td>
                                <td scope="col"width="14%"><a href="luxuy-coach-bus-rental.html"
                                        title="Gaya Airport taxi" target="_new">Deluxe coach</a></td>
                            </tr>
                            <tr>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                1. Are cabs available in Bodhgaya?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingTwo">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                2. How to book a taxi in Bodhgaya?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingThree">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                3. How can I book a taxi from Bodhgaya airport?
                            </button>
                        </h2>
