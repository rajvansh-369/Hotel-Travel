        ...
        <div class="card-body">
            <div class="container mb-5 mt-3">
                <div class="row d-flex align-items-baseline">
                    <div class="col-xl-9">
                        <p style="color: hsl(213, 15%, 56%);font-size: 20px;">Invoice >> <strong>ID: #{{$booked->invoice_no}}</strong></p>
                    </div>
                        ...
                        <div class="col-xl-4">
                            ...
                            <ul class="list-unstyled">
                                <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span
                                        class="fw-bold">ID:</span>#{{$booked->invoice_no}}</li>
                                <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span
                    ...
                    <div class="row my-2 mx-1 justify-content-center">
                        <table class="table table-striped table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">1</th>
                                    <td>{{  \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $booked->start)->format('M d, Y') }}</td>
                                    <td>{{  \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $booked->end)->format('M d, Y') }}</td>
