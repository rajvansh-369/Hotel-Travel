                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:13px 10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <ul class="list-unstyled">
                                                                    <li class="text-muted ms-3"><span class="text-black me-4">SubTotal :</span> <span class="float-end"> Rs {{$hotel->price_per_day * $totalTime}}</span></li>
                                                                    <li class="text-muted ms-3 mt-2"><span class="text-black me-4">  Discount {{$hotel->full_discount_rate}}%:</span>  <span class="float-end price_card"> -  Rs {{number_format($discountPrice , 2)}} </span>  </li>
                                                                    <li class="text-muted ms-3 mt-2"><span class="text-black me-4"> TAX {{$hotel->sale_tax}}% :</span>   <span class="float-end"> +  Rs {{number_format($sale_tax , 2)}} </span>  </li>
                                                         {{-- <li class="text-muted ms-3 mt-2"><span class="text-black me-4">Commission Fees (10%) </span>₹111</li> --}}
                                                                </ul>
                                                                <p class="text-black float-start"><span class="text-black me-3"> Total Amount</span><span
                                                                        style="font-size: 20px;color:green;font-weight:bold"> Rs{{ number_format($totalPrice,2)}}</span> /- Only </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:3px 25px 0px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 150%;"><span
                                                                        style="font-size: 16px; line-height: 24px;">www.hotelsinbodhgaya.com</span>
                                                                </p>
                                                            </div>
